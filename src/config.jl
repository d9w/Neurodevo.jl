...
function input_lengths(cfg::Dict)
    ...
    inputs[4] = cfg["n_cell_params"] + cfg["n_cell_state"] + cfg["n_channels"]
    ...
    inputs[9] = cfg["n_conn_params"] + cfg["n_conn_state"] + cfg["n_channels"]
...
function output_lengths(cfg::Dict)
    ...
    outputs[3] = 1
    outputs[4] = cfg["n_cell_state"] + cfg["n_channels"]
    outputs[5] = cfg["n_cell_params"]
    outputs[6] = 1
    outputs[7] = cfg["n_conn_params"]
    outputs[8] = 1
    outputs[9] = cfg["n_conn_state"] + cfg["n_channels"]
